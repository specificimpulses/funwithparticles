...
INTEGER(GLenum), PARAMETER :: GL_OPERAND2_ALPHA_EXT    = z'859A' ! 0x859A
   integer(glenum), parameter :: GL_ARRAY_BUFFER             = int(z'8892') 
   integer(glenum), parameter :: GL_ELEMENT_ARRAY_BUFFER     = int(z'8893') 
   
   integer(glenum), parameter :: GL_READ_WRITE               = int(z'88ba')
   
   integer(glenum), parameter :: GL_PIXEL_PACK_BUFFER        = int(z'88eb') 
   integer(glenum), parameter :: GL_PIXEL_UNPACK_BUFFER      = int(z'88ec') 

   integer(glenum), parameter :: GL_STREAM_DRAW              = int(z'88e0') 
   integer(glenum), parameter :: GL_STREAM_READ              = int(z'88e1') 
   integer(glenum), parameter :: GL_STREAM_COPY              = int(z'88e2')
    
   integer(glenum), parameter :: GL_STATIC_DRAW              = int(z'88e4') 
   integer(glenum), parameter :: GL_STATIC_READ              = int(z'88e5') 
   integer(glenum), parameter :: GL_STATIC_COPY              = int(z'88e6')
    
   integer(glenum), parameter :: GL_DYNAMIC_DRAW             = int(z'88e8') 
   integer(glenum), parameter :: GL_DYNAMIC_READ             = int(z'88e9') 
   integer(glenum), parameter :: GL_DYNAMIC_COPY             = int(z'88ea') 
...
!     end subroutine glBufferData
     ...
     function glMapBufferOES(target, access) bind(C,name="glMapBufferOES")
       import
       type(C_PTR) :: glMapBufferOES       
       integer(kind=GLenum), value :: target
       integer(kind=GLenum), value :: access
     end function glMapBufferOES
     
     !  
     ! GLboolean glUnmapBuffer(GLenum target)
     subroutine glUnmapBufferOES(target) bind(C,name="glUnmapBufferOES")
       import
       integer(kind=GLenum), value :: target
     end subroutine glUnmapBufferOES
...
SUBROUTINE glClearDepthf(depth) BIND(C,NAME="glClearDepthf")
IMPORT
...
SUBROUTINE glFrustumf(left, right, bottom, top, zNear, zFar)                   &
    BIND(C,NAME="glFrustumf")
IMPORT
REAL(GLfloat), VALUE :: left, right, bottom, top, zNear, zFar
END SUBROUTINE glFrustumf
